                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <div class="btn-group">
                                                        ...
                                                        <!-- <a href="<php echo base_url('spp/laporan_pembayaran4/' . $row['id']); ?>" class="btn btn-sm btn-success">
                                                            <i class="fa fa-file"></i> Laporan Pembayaran
                                                        </a> -->
                                                        <a href="<?php echo base_url('spp/printout/' . $row['id']); ?>" class="btn btn-light" name="printout">
                                                            <b>
